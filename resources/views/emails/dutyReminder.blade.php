...
<ul>
    ...
    <li>Course Name: {{ $duty->course_name }}</li> <!-- Corrected to course_name -->
    <li>Time: {{ \Carbon\Carbon::parse($duty->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($duty->end_time)->format('H:i') }}</li> <!-- Formatting time -->
